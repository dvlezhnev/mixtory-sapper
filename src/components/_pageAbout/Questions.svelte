        ...
        <div class="content">
            <div class="block-first">
                ...
                <div class="stickers-block">
                    ...
                    <div class="text">Первые экземпляры появились на цветных стикерах. А потом эти стикеры превратились в Mixtory – литературную онлайн-игру, в которой можно мешать предложения, пока не надоест. И при этом всегда получать целую историю.</div>
                </div>
            </div>
        </div>
    </div>
