        ...
        <div class="content">
            <div class="block-first">
                ...
                <div class="stickers-block">
                    ...
                    <div class="text">Первые экземпляры появились на цветных стикерах. А потом эти стикеры превратились в Микстори — библиотеку коротких историй со случайным сюжетом.</div>
                </div>
            </div>
        </div>
    </div>
